...
class DoctorController { 
    public: 
        ...
        void Create() {
            uiCommon.TitleBar("Admin > Doctor Management > Create Doctor");
            int flags = 127;
            std::string name;
            int gender = 0;
            int department = 0;
        ...
        void Delete() {
            uiCommon.TitleBar("Admin > Doctor Management > Delete Doctor");
            uiCommon.PressAnyKey(true); 
        }

        void DisplayAll() {
            uiCommon.TitleBar("Admin > Doctor Management > List of Doctors");
            uiCommon.PressAnyKey(true); 
        }
        ...
        void View() {
            ...
            std::cout << "Viewing doctor details..." << std::endl;
            uiCommon.PressAnyKey(true);
        }

        void Search() {
            uiCommon.TitleBar("Admin > Doctor Management > Search Doctor");
            std::cout << "Searching for doctor..." << std::endl;
            uiCommon.PressAnyKey(true);
        }

        void Deactivate() {
            uiCommon.TitleBar("Admin > Doctor Management > Deactivate Doctor");
            std::cout << "Deactivating doctor..." << std::endl;
            uiCommon.PressAnyKey(true);
        }
};
...
static int ReadDoctorMenu() {
    ...
    uiCommon.TitleBar("Admin > Doctor Management");
